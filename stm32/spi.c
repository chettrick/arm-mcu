...
// Calculate the SPI clock prescaler for a given SPI clock rate.  Return an error if
// the frequency isn't possible.

static int SPI_Clock_Prescaler(uint32_t port, uint32_t speed, uint32_t *prescaler)
{
