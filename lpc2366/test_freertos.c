/* Simple FreeRTOS test program for the LPC2366 ARM MCU */

// $Id$

static const char revision[] = "$Id$";

#error This application is currently BROKEN.  I do not currently have FreeRTOS working on the LPC23xx.
...
// Display version information
  ...
  puts("\033[H\033[2JLPC2366 FreeRTOS Test (" __DATE__ " " __TIME__ ")\n");
  puts(revision);
