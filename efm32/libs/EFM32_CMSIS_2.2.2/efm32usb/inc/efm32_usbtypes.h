/***************************************************************************//**
 * @file
 * @brief USB protocol stack library, device type definitions for EFM32.
...
#define MAX_FIFO_SIZE         (512-MAX_NUM_HOSTCHANNELS) /* Unit is 4 bytes */
#else
#define MAX_FIFO_SIZE         512             /* Unit is 4 bytes            */
#endif
